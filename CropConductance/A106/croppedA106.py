...
folder_path = "C:/Users/anechyporenko/Desktop/Measurments/Huzze/Cropped Conductance/A106"
...
for csv_file in csv_files:
    ...
    # Continue with your procedure to extract and crop the desired column
    # Specify the column name you want to extract
    signal_name = 'Shimmer_D630_GSR_Skin_Conductance_CAL'  # Replace 'Your_Column_Name' with the actual column name
